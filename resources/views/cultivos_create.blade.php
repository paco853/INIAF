...
@section('content')
    <div class="card form-card form-card--sm">
        ...
        <form class="grid-form grid-form--sm" method="POST" action="{{ route('cultivos.store') }}">
            @csrf

            <h3 class="section-title">Datos de especie</h3>
            <div class="field">
                <label for="especie">Especie</label>
                <input id="especie" name="especie" type="text" value="{{ old('especie') }}" autocomplete="off" required />
            </div>
            ...
            <div class="two-col-sm" style="grid-column:1/-1;">
                <div class="field">
                    ...
                    <input id="categoria_inicial" name="categoria_inicial" type="text" value="{{ old('categoria_inicial') }}" autocomplete="off" />
                </div>
                <div class="field">
                    <label for="categoria_final">Final</label>
                    <input id="categoria_final" name="categoria_final" type="text" value="{{ old('categoria_final') }}" autocomplete="off" />
                </div>
            </div>
